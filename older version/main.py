...
def check_if_new_user():
    ...
    try:
        ...
        if get_latest_id_in_table_productdetails() == 0:
            print(get_latest_id_in_table_productdetails())
...
def enter_product_details():
    ...
    enter_product_details_into_database(product_name,product_unit,product_price)
...
def enter_product_details_into_database(name, unit, price):
    ...
    try:
        DB_CURSOR.execute(f"INSERT INTO productdetails VALUES({latestID + 1},@pro_name,@pro_unit,@pro_price)")
...
def enter_bill():
    ...
    while True:
        ...
        if check_product_existance(product):
            ...
            if quantity_check(product, quantity) == True:
                ...
                print(f'\n{quantity_check(product, quantity)}')
                continue
        else:
...
def home_page():
    ...
    print("\n---Home Page---\n\n1. Enter bill.\n2. Add Products.\n3. Remove Products.\n4. Edit the Price of a Products.\n5. Show older bills.\n6. Show all the product details (in terminal).\n7. Show all the product details (in csv).\n8. Show all the backup product details (in terminal).\n9. Show all the backup product details (in csv).\n10. Plot Graphs.\n11. Exit.")
    option = input('\nEnter a Valid Option : ')
